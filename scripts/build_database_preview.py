...
DOCS_DIR = os.path.join(REPO_DIR, "docs", "database")
IMG_DIR = os.path.join(REPO_DIR, "assets", "header_photos")
OUTPUT_FILE = os.path.join(REPO_DIR, "..", "database_preview.html")
...
html = html.replace(
    ...
    '<a href="#" onclick="alert(\'このリンクは実際にGitHub Pagesへ公開した後、正しく動作します(プレビューでは無効です)\'); return false;" class="refresh-btn" style="text-decoration:none;">🛒 今買えるピンを見る</a>'
)
