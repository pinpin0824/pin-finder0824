...
DOCS_DIR = os.path.join(SCRIPT_DIR, "..", "docs", "database")
os.makedirs(DOCS_DIR, exist_ok=True)

with open(os.path.join(DATA_DIR, "archive_data.json"), encoding="utf-8") as f:
    pins = json.load(f)
...
<title>Pin Finder Database — 累積ディズニーピン記録集</title>
...
<style>
  :root {
    --navy: #4FA890; --navy-deep: #3B8570; --gold: #A9D6C4; --gold-light: #C9E8DC;
    --red: #E0687A; --teal: #5CC7B8; --cream: #F5FBF9; --cream-dim: #E9F6F1;
    --ink: #33453F; --ink-soft: #6E8A80; --line: #D3ECE3;
  ...
  * { box-sizing: border-box; }
  ...
  body {
    ...
    background-image:
      url("data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A//www.w3.org/2000/svg%22%20width%3D%22520%22%20height%3D%22520%22%20viewBox%3D%220%200%20520%20520%22%3E%0A%20%20%3Cdefs%3E%0A%20%20%20%20%3CradialGradient%20id%3D%22balloonPink%22%20cx%3D%2235%25%22%20cy%3D%2228%25%22%20r%3D%2275%25%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFE3F0%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23F0B8D6%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3CradialGradient%20id%3D%22balloonBlue%22%20cx%3D%2235%25%22%20cy%3D%2228%25%22%20r%3D%2275%25%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E3F3FF%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23B8D8F0%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3CradialGradient%20id%3D%22balloonGold%22%20cx%3D%2235%25%22%20cy%3D%2228%25%22%20r%3D%2275%25%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23FFF6DC%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23F0DBA0%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%20%20%3CradialGradient%20id%3D%22balloonMint%22%20cx%3D%2235%25%22%20cy%3D%2228%25%22%20r%3D%2275%25%22%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%220%25%22%20stop-color%3D%22%23E4FBF1%22/%3E%0A%20%20%20%20%20%20%3Cstop%20offset%3D%22100%25%22%20stop-color%3D%22%23B8E8D0%22/%3E%0A%20%20%20%20%3C/radialGradient%3E%0A%20%20%3C/defs%3E%0A%0A%20%20%3Cg%20opacity%3D%220.4%22%3E%0A%20%20%20%20%3Cellipse%20cx%3D%2270%22%20cy%3D%2260%22%20rx%3D%2222%22%20ry%3D%2227%22%20fill%3D%22url%28%23balloonPink%29%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%2270%22%20y1%3D%2287%22%20x2%3D%2266%22%20y2%3D%22110%22%20stroke%3D%22%23D9A8C4%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%3Cellipse%20cx%3D%22380%22%20cy%3D%2250%22%20rx%3D%2219%22%20ry%3D%2223%22%20fill%3D%22url%28%23balloonBlue%29%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%22380%22%20y1%3D%2273%22%20x2%3D%22377%22%20y2%3D%2293%22%20stroke%3D%22%23A0C4E0%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%3Cellipse%20cx%3D%22470%22%20cy%3D%22260%22%20rx%3D%2217%22%20ry%3D%2221%22%20fill%3D%22url%28%23balloonMint%29%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%22470%22%20y1%3D%22281%22%20x2%3D%22468%22%20y2%3D%22299%22%20stroke%3D%22%239CD0B4%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%3Cellipse%20cx%3D%2240%22%20cy%3D%22300%22%20rx%3D%2218%22%20ry%3D%2222%22%20fill%3D%22url%28%23balloonBlue%29%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%2240%22%20y1%3D%22322%22%20x2%3D%2237%22%20y2%3D%22341%22%20stroke%3D%22%23A0C4E0%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%3Cellipse%20cx%3D%22180%22%20cy%3D%22400%22%20rx%3D%2221%22%20ry%3D%2226%22%20fill%3D%22url%28%23balloonPink%29%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%22180%22%20y1%3D%22426%22%20x2%3D%22176%22%20y2%3D%22448%22%20stroke%3D%22%23D9A8C4%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%20%20%3Cellipse%20cx%3D%22440%22%20cy%3D%22420%22%20rx%3D%2218%22%20ry%3D%2222%22%20fill%3D%22url%28%23balloonGold%29%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%22440%22%20y1%3D%22442%22%20x2%3D%22437%22%20y2%3D%22461%22%20stroke%3D%22%23D4BE84%22%20stroke-width%3D%221.5%22/%3E%0A%20%20%3C/g%3E%0A%0A%20%20%3C%21--%20%E3%81%8B%E3%82%8F%E3%81%84%E3%81%84%E3%81%8A%E5%9F%8E%28%E6%B1%8E%E7%94%A8%E3%82%B7%E3%83%AB%E3%82%A8%E3%83%83%E3%83%88%29%20--%3E%0A%20%20%3Cg%20transform%3D%22translate%28150%2C150%29%22%20opacity%3D%220.28%22%20fill%3D%22none%22%20stroke%3D%22%236FAF98%22%20stroke-width%3D%222.4%22%20stroke-linejoin%3D%22round%22%3E%0A%20%20%20%20%3Crect%20x%3D%220%22%20y%3D%2240%22%20width%3D%2270%22%20height%3D%2238%22%20rx%3D%222%22/%3E%0A%20%20%20%20%3Crect%20x%3D%228%22%20y%3D%2210%22%20width%3D%2216%22%20height%3D%2230%22/%3E%0A%20%20%20%20%3Cpolygon%20points%3D%228%2C10%2016%2C-6%2024%2C10%22/%3E%0A%20%20%20%20%3Crect%20x%3D%2246%22%20y%3D%2210%22%20width%3D%2216%22%20height%3D%2230%22/%3E%0A%20%20%20%20%3Cpolygon%20points%3D%2246%2C10%2054%2C-6%2062%2C10%22/%3E%0A%20%20%20%20%3Crect%20x%3D%2227%22%20y%3D%22-4%22%20width%3D%2216%22%20height%3D%2244%22/%3E%0A%20%20%20%20%3Cpolygon%20points%3D%2227%2C-4%2035%2C-24%2043%2C-4%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%2235%22%20y1%3D%22-24%22%20x2%3D%2235%22%20y2%3D%22-32%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%2235%22%20cy%3D%22-34%22%20r%3D%222.4%22%20fill%3D%22%236FAF98%22/%3E%0A%20%20%20%20%3Crect%20x%3D%2228%22%20y%3D%2258%22%20width%3D%2214%22%20height%3D%2220%22/%3E%0A%20%20%20%20%3Cpath%20d%3D%22M28%2058%20a7%207%200%200%201%2014%200%22/%3E%0A%20%20%3C/g%3E%0A%0A%20%20%3C%21--%20%E3%81%8B%E3%82%8F%E3%81%84%E3%81%84%E8%A6%B3%E8%A6%A7%E8%BB%8A%20--%3E%0A%20%20%3Cg%20transform%3D%22translate%28330%2C300%29%22%20opacity%3D%220.28%22%20fill%3D%22none%22%20stroke%3D%22%235FA890%22%20stroke-width%3D%222.4%22%20stroke-linecap%3D%22round%22%3E%0A%20%20%20%20%3Ccircle%20cx%3D%220%22%20cy%3D%220%22%20r%3D%2236%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%220%22%20cy%3D%220%22%20r%3D%223%22%20fill%3D%22%235FA890%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%220%22%20y1%3D%22-36%22%20x2%3D%220%22%20y2%3D%2236%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%22-36%22%20y1%3D%220%22%20x2%3D%2236%22%20y2%3D%220%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%22-25%22%20y1%3D%22-25%22%20x2%3D%2225%22%20y2%3D%2225%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%22-25%22%20y1%3D%2225%22%20x2%3D%2225%22%20y2%3D%22-25%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%220%22%20cy%3D%22-36%22%20r%3D%224%22%20fill%3D%22%235FA890%22%20stroke%3D%22none%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%220%22%20cy%3D%2236%22%20r%3D%224%22%20fill%3D%22%235FA890%22%20stroke%3D%22none%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%22-36%22%20cy%3D%220%22%20r%3D%224%22%20fill%3D%22%235FA890%22%20stroke%3D%22none%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%2236%22%20cy%3D%220%22%20r%3D%224%22%20fill%3D%22%235FA890%22%20stroke%3D%22none%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%22-25%22%20cy%3D%22-25%22%20r%3D%224%22%20fill%3D%22%235FA890%22%20stroke%3D%22none%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%2225%22%20cy%3D%2225%22%20r%3D%224%22%20fill%3D%22%235FA890%22%20stroke%3D%22none%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%22-25%22%20cy%3D%2225%22%20r%3D%224%22%20fill%3D%22%235FA890%22%20stroke%3D%22none%22/%3E%0A%20%20%20%20%3Ccircle%20cx%3D%2225%22%20cy%3D%22-25%22%20r%3D%224%22%20fill%3D%22%235FA890%22%20stroke%3D%22none%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%220%22%20y1%3D%2236%22%20x2%3D%22-10%22%20y2%3D%2250%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%220%22%20y1%3D%2236%22%20x2%3D%2210%22%20y2%3D%2250%22/%3E%0A%20%20%20%20%3Cline%20x1%3D%22-10%22%20y1%3D%2250%22%20x2%3D%2210%22%20y2%3D%2250%22/%3E%0A%20%20%3C/g%3E%0A%3C/svg%3E");
  ...
  .trending-title { font-size: 13px; font-weight: 700; color: var(--ink-soft); margin-bottom: 4px; }
...
<header>
  ...
  <div class="header-inner">
    <div class="brand-row">
      <div class="brand"><span class="badge-dot"></span>Pin Finder Database</div>
      <button id="refreshBtn" class="refresh-btn" title="最新データに更新">⟳ 更新</button>
      <a href="../" class="refresh-btn" style="text-decoration:none;">🛒 今買えるピンを見る</a>
      <div class="brand-tag">Historical Archive</div>
    </div>
    <h1 class="hero-title">すべての記録を、ここに残していく。</h1>
    <p class="hero-sub">一度見つかったピンは、売り切れても記録として蓄積される累積データベースです。</p>
    <input type="text" id="search" placeholder="ピン名・キャラクター・シリーズ・Pin ID で検索…">
    <p class="search-note">※ ここは「購入用」ではなく「記録・図鑑」用のページです。似た商品・同一商品が見つかることはありますが、表示されているリンク・価格は出品当時のものです(現在買えるページとは限りません)。</p>
...
<footer>Pin Finder Database — 累積記録アーカイブ / データ出典: eBay Browse API（米国市場） / 1時間ごとに新規ピンを追加</footer>
...
function cardHtml(p, idx) {
  ...
  return `
    <div class="pin-card" data-idx="${idx}">
      ...
      <div class="pin-price" style="color:var(--ink-soft); font-size:11.5px;">参考価格: $${p.min_price.toFixed(2)} – $${p.max_price.toFixed(2)}(取得時点)</div>
...
// 今週のトレンド: 過去7日以内に「発見」されたピンを、キャラクター別に集計する。
// (これは累積データベースが持つ first_seen_date を使った集計であり、
...
function openModal(p) {
  ...
  document.getElementById('modalBody').innerHTML = `
    ...
    <div class="detail-row"><span>参考価格帯(取得時点)</span><span>$${p.min_price.toFixed(2)} – $${p.max_price.toFixed(2)}</span></div>
    <div class="detail-row"><span>参考平均価格</span><span>$${p.avg_price.toFixed(2)}</span></div>
...
shutil.copy(os.path.join(DATA_DIR, "archive_data.json"), os.path.join(DOCS_DIR, "pins_data.json"))

# ヘッダー写真は docs/images/ (Pin Finder側)を共有参照するため、ここではコピーしない
# (HTML内の "images/header-N.jpg" パスは "../images/header-N.jpg" に置き換える)
